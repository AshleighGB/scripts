...
sleep 3
clear
echo "******** Running Installer ( apache2 ) ********"
apt-get -y install apache2
service apache2 stop
service apache2 start
echo "******** Installer Completed ( apache2 ) ********"
sleep 3
clear
echo "******** Running Installer ( php5 ) ********"
apt-get -y install php5 php5-mysql php5-gd php5-imagick
service apache2 stop
service apache2 start
echo "******** Installer Completed ( php5 ) ********"
sleep 3
clear
